...
namespace Core.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public CategoryService(IRepository<MainCategory> mainCategoryRepository, IRepository<Category> categoryRepository, IMapper mapper, IRepository<SubCategory> subCategoryRepository)
        {
