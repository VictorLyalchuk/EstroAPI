...
namespace Core.Services
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(IMapper mapper, IRepository<Product> productRepository, IRepository<Category> categoryRepository, IFilesService filesService, IImageService imageService, IRepository<Storage> storageRepository, IRepository<Image> imageRepository)
        {
            _mapper = mapper;
        ...
        {
            var product = _mapper.Map<Product>(editProductDTO);
